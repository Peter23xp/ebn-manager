...
export function MobileMoneyPaymentForm({ amount, submitting = false, onSubmit }: { amount: number; submitting?: boolean; onSubmit: (input: { provider: KpayProvider; phoneNumber: string }) => void }) {
